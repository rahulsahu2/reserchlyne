                                ...
                                <div class="row g-3 pt-3 justify-content-center">
                                    <div class="col-lg-12 m-auto">
                                        ...
                                        <?php  if ($extend_date){ ;?>
                                            ...
                                            <div class="profile-profile">
                                            <p>Join Date : <span>  <?php echo $effectiveDate = date('d-m-Y', strtotime("-$duration[0] months", strtotime($user->extend_date))); ?> </span></p>
                                        </div> 

                                     
                                         <div class="profile-profile">
                                          <p>Due Date : <span> <?php echo $user->extend_date;?></span></p>
                                         </div>
