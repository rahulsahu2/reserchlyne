...
<section class="complaints py-5">
    <div class="container">
        ...
        <div class="row pt-4">
            ...
            <div class="col-md-12">
                <div class="title common text-center">
                    <h2 class="text-center text-capitalize mb-4 mt-4">
            ...
            <h3 style="text-transform: none; margin-top:75px;" class="fadeInUp" data-wow-delay="0.3s">Links :</h3>
            <ul>
                <li><i class="fa fa-envelope"></i> Email to <a style="color: blue;" href="mailto:info.midcaps.in@gmail.com">info.amiteshwar.in@gmail.com</a> for Complaint</li>
