...
<?php $info_data= $this->common_model->getsingle('home_info', array('id'=>1)); ?>   
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-12 col-lg-10 button-banner">
                                    <h1 class="text-light text-uppercase mb-3 animated slideInDown">
                                        Welcome to Amiteshwar.in
                                    </h1>
    ...
    <div class="container-xxl py-5">
      <div class="container">
        <div class="row  align-items-center">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
            <div class="h-100">
                ...
                <section>
                    <div class="container-xxl py-2">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="m-0 market"> <?php echo $info_data->marquee_title;?></h3>
                                </div>
                                <div class="col-md-8">
                                    <marquee>
                            ...
                            <div class="row">
                                <h3 class="text-center pt-4"><?php echo $info_data->f_title;?></h3>
                                <hr class="w-25 m-auto">
                                <div class="col-md-12 market-stock">
                                    <div class="owl-carousel marketing pt-4">
                                           <?php if($fast_data){ foreach($fast_data as $value){?>
                                        <div class="testimonial-item">
                                            <div class="front face">
                                                ...
                                                <div class="weakly">
                                                    ...
                                                    <h4 class="text-center" style="margin: 0; font-weight: bolder; color: #8ea358; letter-spacing: 4px;border-top: 2px solid #9c9c9c;">+<?php echo $value->final_price;?>%</h4>
                                                    
                                                    <h6 class="text-center" style="font-weight: bold; text-transform:uppercase; margin: 0px;">WITHIN &nbsp;<?php echo $value->final_date;?> &nbsp;Weeks</h6>
                    ...
                    <div class="container">
                        <div>
                            <div class="title common text-center">
                                <h2><?php echo $info_data->s_title;?></h2>
                            </div>
                            <div class="main text-center">
                                <div class="row justify-content-center">
                              <?php if($star_data){ foreach($star_data as $value1){?>

                                    <div class="col-md-6 col-lg-3">
                                        <div class="item" style="background-color: #3385d9; color: white; margin-top: 10px;">
                                  ...
                                  <!--   <div class="col-md-3 col-sm-6">
                                        <div class="item" style="background-color: #3385d9; color: white; margin-top: 10px;">
                                            ...
                                            <table width="100%" height="100%" border="1">
                                                <tbody>
                                                    <tr>
                                                        <th style="text-align:center;" colspan="2">Aegis Logistics Ltd.</th>
                                                    </tr>
                                                    <tr align="center" style="font-size:12px; font-weight:900;">
                                                        <td>Rec. Price<br><sup>13<sup>th</sup> Jul, 2022</sup>
                                                        </td>
                                                        <td>206.30</td>
                                                    </tr>
                                                    <tr align="center" style="font-size:12px; font-weight:900;">
                                                        <td>High Price<br><sup>1<sup>st</sup> Sep, 2022</sup>
                                                        </td>
                                                        <td>303.55</td>
                                                    </tr>
                                                    <tr>
                                                        <th style="text-align:center; text-transform:uppercase;" colspan="2">+47.14%<br>WITHIN 7 Weeks</th>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="item" style="background-color: #3385d9; color: white; margin-top: 10px;">
                                            ...
                                            <table width="100%" height="100%" border="1">
                                                <tbody>
                                                    <tr>
                                                        <th style="text-align:center;" colspan="2">Intellect Design Arena Ltd.</th>
                                                    </tr>
                                                    <tr align="center" style="font-size:12px; font-weight:900;">
                                                        <td>Rec. Price<br><sup>19<sup>th</sup> Feb, 2022</sup>
                                                        </td>
                                                        <td>681.15</td>
                                                    </tr>
                                                    <tr align="center" style="font-size:12px; font-weight:900;">
                                                        <td>High Price<br><sup>7<sup>th</sup> Apr, 2022</sup>
                                                        </td>
                                                        <td>986.65</td>
                                                    </tr>
                                                    <tr>
                                                        <th style="text-align:center; text-transform:uppercase;" colspan="2">+44.85%<br>WITHIN 7 Weeks</th>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="item" style="background-color: #3385d9; color: white; margin-top: 10px;">
                                            ...
                                            <table width="100%" height="100%" border="1">
                                                <tbody>
                                                    <tr>
                                                        <th style="text-align:center;" colspan="2">Oil India Ltd.</th>
                                                    </tr>
                                                    <tr align="center" style="font-size:12px; font-weight:900;">
                                                        <td>Rec. Price<br><sup>11<sup>th</sup> May, 2022</sup>
                                                        </td>
                                                        <td>220.50</td>
                                                    </tr>
                                                    <tr align="center" style="font-size:12px; font-weight:900;">
                                                        <td>High Price<br><sup>10<sup>th</sup> Jun, 2022</sup>
                                                        </td>
                                                        <td>306.00</td>
                                                    </tr>
                                                    <tr>
                                                        <th style="text-align:center; text-transform:uppercase;" colspan="2">+38.78%<br>WITHIN 4 Weeks</th>
                                                    </tr>
                                                </tbody>
                                            </table>
 ...
 -->
                ...
                <div class="container-xxl py-5">
                    <div class="container">
                        <div class="row ">
                            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                                <div class="border-start border-5 border-color ps-4 mb-5">
                                    <h6 class="text-body text-uppercase mb-2">Why Amiteshwar.in</h6>
                                    <h1 class="display-6 mb-0">
                                        <?php echo $info_data->whyme_title;?>
                                    </h1>
                                </div>
                                <p class="mb-5">
                                ...
                                <div class="row gy-5 gx-4">
                                    <div class="col-sm-6 wow fadeIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                        <div class="d-flex align-items-center mb-3">
                                            <i class="fa fa-check fa-2x icon-color flex-shrink-0 me-3"></i>
                                            <h6 class="mb-0"><?php echo $info_data->key1_title;?></h6>
                                        </div>
                                        <?php 
                                        $num_words = 21;
                                         $words = array();
              ...
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
                <div class="d-flex align-items-center mb-3">
                  <i class="fa fa-check fa-2x icon-color flex-shrink-0 me-3"></i>
                  <h6 class="mb-0"><?php echo $info_data->key2_title;?></h6>
                </div>
              <?php 
                   $num_words = 21;
                          $words = array();
              ...
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
                <div class="d-flex align-items-center mb-3">
                  <i class="fa fa-check fa-2x icon-color flex-shrink-0 me-3"></i>
                  <h6 class="mb-0"><?php echo $info_data->key3_title;?></h6>
                </div>
              ...
              <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
                <div class="d-flex align-items-center mb-3">
                  <i class="fa fa-check fa-2x icon-color flex-shrink-0 me-3"></i>
                  <h6 class="mb-0"><?php echo $info_data->key4_title;?></h6>
                </div>
               <?php 
                                        $num_words = 21;
                                         $words = array();
...
What makes us your best choice.</h2>
        </div>
                                                ...
                                                <div class="row g-3 ">
                                                    <div class="col-sm-6 mt-5 mt-md-3 mt-lg-3">
                                                        <div class="form-floating">
                                                            <input type="text" name="name"class="form-control bg-dark border-0" id="name" placeholder="Enter your name" required />
                                                    ...
                                                    <div class="col-sm-6 col-sm-6 mt-5 mt-md-3 mt-lg-3 phone-class">
                                                        <div class="form-floating">
                                                            <input type="email" name="gmail" class="form-control bg-dark border-0" id="gmail" placeholder="Enter your gmail" required/>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-floating">
                                                            <!-- <input type="number" name="mobile" class="form-control bg-dark border-0" id="mobile" placeholder="Enter your phone no " /> -->
                                                             <input type="text" name="mobile" class="form-control bg-dark border-0" placeholder="Phone Number" 
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-floating">
                                                            <input type="text" name="subject" class="form-control bg-dark border-0" id="subject" placeholder="Enter your Subject " required>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-floating">
                                                            <textarea class="form-control bg-dark border-0" placeholder="Leave a message here" name="message" id="message" style="height: 100px"  required></textarea >
                                                            <label for="message">Message</label>
                                                             <span><?= form_error('message') ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                         <button class="btn same-color text-white w-100 py-3" type="submit"  value="submit" name="submit"> 
                    Send Message
                  </button> 
                                                    </div>
                                                </div>
