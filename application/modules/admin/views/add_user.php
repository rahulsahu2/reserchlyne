				...
				<input type="hidden" name="submithiddenform" value="1">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="name" value="<?php  echo $user->name; ?>"  placeholder="Plese enter  Name"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="phone" name="phone" value="<?php  echo $user->phone; ?>"  placeholder="Plese enter Phone"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="email" id="email" name="email" value="<?php  echo $user->email; ?>"  placeholder="Plese enter Mobile"   class="form-control col-md-7 col-xs-12">
							...
							<!-- <div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="email" id="email" name="email" value="<?php  echo $user->email; ?>"  placeholder="Plese enter  Email"   class="form-control col-md-7 col-xs-12">
								<span style="color:red;"><?php echo form_error('email'); ?></span>
							  </div>
							</div> -->
												<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="password" name="password" value="<?php  echo $user->password; ?>"  placeholder="Plese enter Password"   class="form-control col-md-7 col-xs-12">
