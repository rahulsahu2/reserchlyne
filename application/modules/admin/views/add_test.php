						...
						<form id="demo-form2" action="" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
							  ...
							  <select id="path_id" name="path_id" class="form-control col-md-7 col-xs-12">
									...
									<option value="<?php echo $path->id; ?>" <?php if(set_value('path_id')==$path->id){ echo "selected"; } ?> >
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="name" value="<?php  echo set_value('name'); ?>"  placeholder="Plese enter test name" required="required" class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="price" name="price" value="<?php  echo set_value('price'); ?>"  placeholder="Plese enter test price" required="required" class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
							  <textarea class="form-control col-md-7 col-xs-12" id="description" name="description" placeholder="Plese enter test description" rows="2" cols="20"><?php  echo set_value('description'); ?></textarea>
