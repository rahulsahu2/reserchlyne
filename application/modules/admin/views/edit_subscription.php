                ...
                <div class="x_content">
                  ...
                  <form id="demo-form2" action="" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Subscription Title  </label>
					 ...
					 <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Plan Duration  </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="duration" name="duration" value="<?php  echo $cdata->duration; ?>"  placeholder="Plese enter Plan Duration"   class="form-control col-md-7 col-xs-12">
						<span style="color:red;"><?php echo form_error('duration'); ?></span>
					  </div>
                    </div>
									<input type="hidden" name="submithiddenform" value="1">
					 <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Original Price </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="price" name="price" value="<?php  echo $cdata->price; ?>"  placeholder="Plese enter price"   class="form-control col-md-7 col-xs-12">
						<span style="color:red;"><?php echo form_error('price'); ?></span>
					  </div>
                    </div>
					
					 <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Discounted Price  </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="discounted_price" name="discounted_price" value="<?php  echo $cdata->discounted_price; ?>"  placeholder="Plese enter discounted price"   class="form-control col-md-7 col-xs-12">
						<span style="color:red;"><?php echo form_error('discounted_price'); ?></span>
					  </div>
                    </div>
					
					 <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Off on price  </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="off_price" name="off_price" value="<?php  echo $cdata->off_price; ?>"  placeholder="Plese enter off on price"   class="form-control col-md-7 col-xs-12">
