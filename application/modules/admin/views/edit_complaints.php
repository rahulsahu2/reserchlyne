        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Number of investor complaints <small></small></h2>
                  ...
                  <form id="demo-form2" action="" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="received_form" value="<?php  echo $cdata->received_form; ?>"  placeholder="Plese enter title"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="pending_c" value="<?php   echo $cdata->pending_c; ?>"  placeholder="Plese enter duration"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="received_c	" name="received_c" value="<?php  echo $cdata->received_c; ?>"  placeholder="Plese enter title"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="resolved_c" name="resolved_c" value="<?php  echo $cdata->resolved_c; ?>"  placeholder="Plese enter price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="total_pending" name="total_pending" value="<?php  echo $cdata->total_pending; ?>"  placeholder="Plese enter discounted price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="pending_complains" name="pending_complains" value="<?php  echo $cdata->pending_complains; ?>"  placeholder="Plese enter off on price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="average_time" name="average_time" value="<?php  echo $cdata->average_time; ?>"  placeholder="Plese enter title"   class="form-control col-md-7 col-xs-12">
...
SR NO.  
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="sr_no_m" value="<?php  echo $cdata->sr_no_m; ?>"  placeholder="Plese enter title"   class="form-control col-md-7 col-xs-12">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="month" value="<?php  echo $cdata->month; ?>"  placeholder="Plese enter title"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="previous_month" value="<?php  echo $cdata->previous_month; ?>"  placeholder="Plese enter duration"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="received_m" value="<?php  echo $cdata->received_m; ?>"  placeholder="Plese enter price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="resolved_m" value="<?php  echo $cdata->resolved_m; ?>"  placeholder="Plese enter discounted price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="pending_m" value="<?php  echo $cdata->pending_m; ?>"  placeholder="Plese enter off on price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="sr_no_y" value="<?php  echo $cdata->sr_no_y; ?>"  placeholder="Plese enter title"   class="form-control col-md-7 col-xs-12">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="year" value="<?php  echo $cdata->year; ?>"  placeholder="Plese enter title"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="carried_forward" value="<?php  echo $cdata->carried_forward; ?>"  placeholder="Plese enter duration"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="received_y" value="<?php  echo $cdata->received_y; ?>"  placeholder="Plese enter price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="resolved_y" value="<?php  echo $cdata->resolved_y; ?>"  placeholder="Plese enter discounted price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="pending_y" value="<?php  echo $cdata->pending_y; ?>"  placeholder="Plese enter off on price"   class="form-control col-md-7 col-xs-12">
