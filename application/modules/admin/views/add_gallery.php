						...
						<form id="demo-form2" action="" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="title" value="<?php  echo set_value('title'); ?>"  placeholder="Plese enter title" required="required" class="form-control col-md-7 col-xs-12">
