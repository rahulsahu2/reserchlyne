            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_content"><br />
                        ...
                        <div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="question" name="question[]" value="<?php  echo $cdata->question; ?>"  placeholder="Plese enter Question" required="required" class="form-control col-md-7 col-xs-12">
                <input type="hidden" id="id" name="id"value="<?php  echo $cdata->id; ?>" >
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="answer" name="answer[]" value="<?php  echo $cdata->answer; ?>"  placeholder="Plese enter Answer" required="required" class="form-control col-md-7 col-xs-12">
