				...
				<input type="hidden" name="submithiddenform" value="1">
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="analysis" name="analysis" value="<?php  echo $cdata->analysis; ?>" placeholder="Plese enter Analysis"   class="form-control col-md-7 col-xs-12">
								<input type="hidden" id="id" name="id"value="<?php  echo $cdata->id; ?>" >
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="file" name="pdf"  id="pdf" size="20" value="<?php  echo $cdata->id; ?>"  placeholder="Plese enter Analysis pdf"   class="form-control col-md-7 col-xs-12" >
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="company" name="company" value="<?php  echo $cdata->company; ?>" placeholder="Plese enter Company"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="bse" name="bse" value="<?php  echo $cdata->bse; ?>"  placeholder="Plese enter BSE Code"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="nse" name="nse" value="<?php  echo $cdata->nse; ?>" placeholder="Plese enter NSE Code"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="recommendation" name="recommendation" value="<?php  echo $cdata->recommendation; ?>" placeholder="Plese enter Recommendation"   class="form-control col-md-7 col-xs-12">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="recommended_price" name="recommended_price" value= "<?php  echo $cdata->recommended_price; ?>"  placeholder="Plese enter Recommended Price"   class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="target_price" name="target_price" value="<?php  echo $cdata->target_price; ?>"  placeholder="Plese enter Recommended Price"   class="form-control col-md-7 col-xs-12">
