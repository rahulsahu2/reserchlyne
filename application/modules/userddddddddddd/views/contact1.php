...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>site_assets/styles/services.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>site_assets/styles/services_responsive.css">
</head>
<body>
...
<div class="super_container">
	...
	<div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url(); ?>site_assets/images/services.jpg" data-speed="0.8"></div>
			...
			<div class="row">
				<div class="col">
					<div class="features_container d-flex flex-row flex-wrap align-items-start justify-content-between">
						...
						<!-- Feature -->
						<div class="feature">
							<div class="feature_image"><img src="<?php echo base_url(); ?>site_assets/images/features_1.jpg" alt=""></div>
						...
						<!-- Feature -->
						<div class="feature">
							<div class="feature_image"><img src="<?php echo base_url(); ?>site_assets/images/features_2.jpg" alt=""></div>
							<div class="feature_content">
						...
						<!-- Feature -->
						<div class="feature">
							<div class="feature_image"><img src="<?php echo base_url(); ?>site_assets/images/features_3.jpg" alt=""></div>
							<div class="feature_content">
	...
	<div class="text_section">
		<div class="container">
			<div class="row">
				...
				<!-- Text Section Image -->
				<div class="col-lg-5">
					<div class="text_section_image"><img src="<?php echo base_url(); ?>site_assets/images/text_section.jpg" alt=""></div>
				</div>
