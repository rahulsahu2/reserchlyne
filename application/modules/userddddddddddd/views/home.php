...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>site_assets/styles/bootstrap4/bootstrap.min.css">
<link href="<?php echo base_url(); ?>site_assets/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>site_assets/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>site_assets/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>site_assets/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>site_assets/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>site_assets/styles/responsive.css">
	<!-- Home -->
	<div class="home">
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(<?php echo base_url(); ?>site_assets/images/home_background_1.jpg)"></div>
	...
	<div class="about">
		<div class="container">
			<div class="row row-lg-eq-height">
				...
				<!-- About Image -->
				<div class="col-lg-5">
					<div class="about_image"><img src="<?php echo base_url(); ?>site_assets/images/about.png" alt=""></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="departments">
		<div class="departments_background parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url(); ?>site_assets/images/departments.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
			...
			<div class="row departments_row row-md-eq-height">
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						<div class="dept_image"><img src="<?php echo base_url(); ?>site_assets/images/dept_1.jpg" alt=""></div>
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						<div class="dept_image"><img src="<?php echo base_url(); ?>site_assets/images/dept_2.jpg" alt=""></div>
						<div class="dept_content text-center">
				...
				<div class="col-lg-3 col-md-6 dept_col">
					<div class="dept">
						<div class="dept_image"><img src="<?php echo base_url(); ?>site_assets/images/dept_3.jpg" alt=""></div>
						<div class="dept_content text-center">
		...
		<div class="container">
			...
			<div class="row services_row">
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="<?php echo base_url(); ?>site_assets/images/service_1.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="<?php echo base_url(); ?>site_assets/images/service_2.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="<?php echo base_url(); ?>site_assets/images/service_3.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="<?php echo base_url(); ?>site_assets/images/service_4.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="<?php echo base_url(); ?>site_assets/images/service_5.svg" alt=""></div>
				...
				<div class="col-lg-4 col-md-6 service_col">
					<a href="services.html">
						<div class="service text-center trans_200">
							<div class="service_icon"><img class="svg" src="<?php echo base_url(); ?>site_assets/images/service_6.svg" alt=""></div>
							<div class="service_title trans_200">Biochemistry  aakaa</div>
							<div class="service_text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ante leo, finibus quis est ut, tempor tincidunt ipsum. Nam consequat semper sollicitudin.</p>
							</div>
						</div>
	...
	<div class="cta">
		<div class="cta_background parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url(); ?>site_assets/images/cta.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
