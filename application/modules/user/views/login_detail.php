...
<?php if ($msg != '') { ?>
  ...
  <p style="color:green;font-size: larger;text-align:center;"><b>
      <?php echo $msg; ?>
    </b></p>
  ...
  <div class="container">
    ...
    <h5 class="text-center text-body">Offers Ending Soon &nbsp;&nbsp;
      ...
      <div class="counter" style='color: blue;'>
        ...
        <span style="display: none;" class='e-m-days'>
          <?= date('d') ?>
        </span>
        <span class='e-m-hours'>
          <?= date('h') ?>
        </span> Hours |
        <span class='e-m-minutes'>
          <?= date('i') ?>
        </span> Minutes |
        <span class='e-m-seconds'>
          <?= date('s') ?>
        </span> Seconds
      </div>
      </p>
    ...
    <h2 class="text-center">
      <?php echo $login_data->header_title; ?>
    </h2>
    ...
    <div class="row pt-5 g-5 justify-content-center">
      <div class="col-lg-12 text-center d-flex">
        <div class="heading heading-1 w-100">
          <h5>
            <?php echo $login_data->key1_title; ?>
          </h5>
          <h4> <sup><img width="50" src="https://www.midcaps.in/images/new.gif"></sup>
            <?php echo $login_data->key2_title; ?>
          </h4>

          <h5 class="text-dark">
            <?php echo $login_data->key3_title; ?>
          </h5>
          <h5 class="text-dark">Rs.
            <?php echo $login_data->discount_price; ?>/-( <span class="" style="text-decoration: line-through;"> Rs.
              <?php echo $login_data->original_price; ?>/-
            </span>)
          </h5>
          <div class="btn-submit btn-submit1 pb-0 pt-4">
            ...
            <a href="javascript:void(0)" id="myBtn">
              <?php echo ((($login_data->original_price - $login_data->discount_price) / $login_data->original_price) * 100) ?>%
              off renew now
            </a>
  ...
  <div class="container">
    ...
    <?php if ($news) { ?>
      ...
      <?php foreach ($news as $value) { ?>
        <h5 class="text-center text-body">DATED :
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="light-bg"><a href="<?php echo base_url(); ?>assets/img/<?php echo $value->pdf; ?>"
                        target="_blank" download class="btn same-color text-white">
                        <?php echo $value->analysis; ?>
                      </a></td>
                    <td style="font-size:14px; font-weight:900; text-align: center;">
                      <?php echo $value->company; ?>
                    </td>
                    <td class="light-bg" style="font-size:14px; font-weight:900;text-align: center;">
                      <?php echo $value->bse; ?>
                    </td>
                    <td style="font-size:14px; font-weight:900;text-align: center;">
                      <?php echo $value->nse; ?>
                    ...
                    <td class="light-bg" style="font-size:14px; font-weight:900;text-align: center;">
                      <?php echo $value->recommendation; ?>
                    </td>
                    <td style="font-size:14px; font-weight:900;text-align: center;">
                      <?php echo $value->recommended_price; ?>
                    </td>
                    <td class="light-bg" style="font-size:14px; font-weight:900;text-align: center;">
                      <?php echo $value->target_price; ?>
                    </td>
                  </tr>
          ...
          <?php foreach ($pre as $value) { ?>
            <div class="col-lg-2 col-md-3 col-sm-4">
              <div class="buttons1 ">
                ...
                <a href="<?php echo base_url(); ?>assets/img/<?php echo $value->pdf; ?>" class="btn all-btn">NEWSLETTER<br>
                  DATED<br>
                  <?php echo date('d-m-Y', strtotime($value->date)); ?>
                </a>
              </div>
  ...
  <div class="modal-content">
    ...
    <form action="#" method="POST">
      ...
      <div class="modal-footer">
        <input type="submit" class="btn btn-success" id="buy_now" data-amount="<?php echo $data_amount; ?>"
          data-id="<?php echo $data_id; ?>" user-id="<?php echo $user_id; ?>" user-name="<?php echo $name; ?>"
          user-email="<?php echo $email; ?>" user-phone="<?php echo $phone; ?>" user-address="<?php echo $address; ?>"
          value="OK">
      </div>
    </form>
  </div>
...
<!-- Back to Top -->
<a href="#" class="btn btn-lg same-color text-white btn-lg-square back-to-top"><i class="bi bi-arrow-up"></i></a>
      ...
      "handler": function (response) {
        ...
        $.ajax({
          ...
          success: function (msg) {
            ...
            // window.location = "<?php echo base_url('user/razorPaySuccess'); ?>";
