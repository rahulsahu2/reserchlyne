        ...
        <div class="container">
            <div class="pricing-inner">
                <div class="title common text-center">
                    <h2 class=""><span class="title">Benefits</span></h2>
      ...
      <section class="price-sec">
            <div class="container">
                <div class="common text-center">
                    ...
                    <h3 style="margin-top: 0; color: #3385d9;font-weight: bold;"><span class="title">GET LOGIN DETAILS JUST AFTER SUBSCRIPTION</span></h3>
...
var options = {
"key": "rzp_live_OkVNyeILcznmr3",  //rzp_live_pdScwBe73edCyD
